                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="footer-content text-center padding-ver-clear">
                            ...
                            <ul class="list-inline mb-20">
                                ...
                                <li><a href="tel:8096863215" class="link-dark"><i class="text-default fa fa-phone pl-10 pr-5"></i>809-686-3215</a></li>
                                <li><a href="mailto:info@geomatica.biz" class="link-dark"><i class="text-default fa fa-envelope-o pl-10 pr-5"></i>info@geomatica.biz</a></li>
                            </ul>
